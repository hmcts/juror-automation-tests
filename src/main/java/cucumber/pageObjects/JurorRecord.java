    ...
    public void deferralRefusedjurorsTabPresent(final String tabName) {
        ...
        switch (tabName) {
            ...
            case "Postcode":
                ...
                log.info(" Text - " + DeferralGrantedResultsheaderTableName.get(3).getText() + " - is visible on the page ");
                break;
            case "Status":
                Assert.assertTrue("Expected Text not found", DeferralRefusedResultsheaderTableName.get(4).getText().equals(tabName));
                log.info(" Text - " + DeferralGrantedResultsheaderTableName.get(4).getText() + " - is visible on the page ");
                break;
            case "Date Refused":
                Assert.assertTrue("Expected Text not found", DeferralRefusedResultsheaderTableName.get(5).getText().equals(tabName));
                log.info(" Text - " + DeferralGrantedResultsheaderTableName.get(5).getText() + " - is visible on the page ");
                break;
            case "Reason":
                Assert.assertTrue("Expected Text not found", DeferralRefusedResultsheaderTableName.get(6).getText().equals(tabName));
                log.info(" Text - " + DeferralGrantedResultsheaderTableName.get(6).getText() + " - is visible on the page ");
                break;
            case "Date printed":
                Assert.assertTrue("Expected Text not found", DeferralGrantedResultsheaderTableName.get(7).getText().equals(tabName));
                log.info(" Text - " + DeferralGrantedResultsheaderTableName.get(7).getText() + " - is visible on the page ");
                break;
