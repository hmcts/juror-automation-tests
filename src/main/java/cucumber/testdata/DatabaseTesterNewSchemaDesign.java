...
//			pStmt.execute();
	...
	public void addBankHolidayForYear2024() throws SQLException {
		db = new DBConnection();
		...
		try {
			...
			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-03-29','Good Friday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-04-01','Easter Monday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-05-06','Early May bank holiday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-05-27','Spring bank holiday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-08-26','Summer bank holiday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-12-25','Christmas Day',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2024-12-26','Boxing Day',true)");
			pStmt.executeUpdate();
	...
	public void addBankHolidayForYear2025() throws SQLException {
		db = new DBConnection();
		...
		try {
			...
			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-01-01','New years Day',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-04-18','Good Friday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-04-21','Easter Monday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-05-05','Early May bank holiday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-06-26','Spring bank holiday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-08-25','Summer bank holiday',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-12-25','Christmas Day',true)");
			pStmt.executeUpdate();

			pStmt = conn.prepareStatement("INSERT INTO juror_mod.holiday (loc_code, holiday, description, public) VALUES (null,'2025-12-26','Boxing Day',true)");
			pStmt.executeUpdate();
