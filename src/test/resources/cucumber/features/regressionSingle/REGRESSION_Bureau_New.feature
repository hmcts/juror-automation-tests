...
Scenario: Log on
	...
	Given bureau username "CPASS" has "LOGIN_ENABLED_YN" set to "Y"
	And I have reset user "CPASS"

	#1st attempt

	When I log in with "CPASS" and "WrongPassword"
	Then I see "There is a problem" on the page
	And I see "Username and password do not match - try again. You’ll be locked out of your account after 3 attempts." on the page
	...
	When I log in with "CPASS" and "WrongPassword"
	Then I see "There is a problem" on the page
	And I see "Your account is locked because you entered incorrect details 3 times. To unlock your account, contact your manager." on the page

	#invalid username

	When I log in with "BOB" and "WrongPassword"
	Then I see "There is a problem" on the page
	And I see "Username and password do not match - try again. You’ll be locked out of your account after 3 attempts." on the page
	...
	Then I see "There is a problem" on the page
	And I see "Enter your username" on the page
	And I see "Enter your password" on the page

	#no username

	When I log in with "" and "password"
	Then I see "There is a problem" on the page
	And I see "Enter your username" on the page

	#no password

	When I log in with "SYSTEM" and ""
	Then I see "There is a problem" on the page
	And I see "Enter your password" on the page

	#successful log on as manager
	...
	And I see "Password" on the page

	Then bureau username "CPASS" has "LOGIN_ENABLED_YN" set to "Y"
	And I have reset user "CPASS"

	#successful log on as team member

	And I log in as "ARAMIS1"
	And I see link with text "Your work"
	And I see link with text "Search"
	And I do not see link with text "Assign Replies"
	And I do not see link with text "Manage team"
...
#	Given bureau username "CPASS" has "PASSWORD_CHANGED_DATE" set to "2020-12-21 00:00:00"
	Given bureau username "CPASS" has an expired password
	When I log in as "CPASS"
	And I see "There is a problem" on the page
	And I see "Your password has expired. Please use the facility in the Juror application to specify a new one" on the page
