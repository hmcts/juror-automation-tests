...
@RegressionWelsh @JDB-3072 @JDB-3466 @JDB-3887 @JDB-3790 
Scenario Outline: Welsh 3rd Party Underage
	...
	And I see "Bu ichi ddweud mai dyddiad geni'r unigolyn oedd 27 Ebrill 2006" on the page
...
Examples:
	...
	|641500868		|LNAMEEIGHTSIXEIGHT		|CH1 2AN	|b@eeee.com	|415170401	|