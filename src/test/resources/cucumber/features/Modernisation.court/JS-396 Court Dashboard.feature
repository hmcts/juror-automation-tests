...
#    And I press the "Save and back to all days" button
    ...
    And on the dashboard the total due to attend matches "11"
    ...
    When I backdate juror "<juror_number21>"'s attendance by "366" days

    When I click on the "HMCTS Juror" link

    And on the dashboard the total unpaid attendances matches "-"
    And on the dashboard the oldest unpaid attendance is "-" days old
