...
Examples:
	...
	|645100710	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	|email 		|pool_no	|
	|645100443	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	|email           	|pool_no	|
	|645100187	|DOE		|SW1H 9AJ	|email@outlook.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	| email 	| pool_no	|
	|645100192	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	|email 		|pool_no	|
	|645100380	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	| email 	| pool_no	|
	|645100411	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	|email 		|pool_no	|
	|645100935	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
...
Examples:
	|part_no	|last_name	|postcode	|email 		|pool_no	|
	|645100043	|DOE		|SW1H 9AJ	|a@eeee.com	|451170401	|
