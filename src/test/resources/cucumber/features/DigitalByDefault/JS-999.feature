Feature: JS-999
  ...
  @JurorTransformation
  Scenario Outline: As a juror I want to see the digital by default landing screen before continuing my response
    ...
    And I see What jury service involves card
    And I see When and where to attend card
    And I see Claiming expenses card
    And I see Employment and time off work card
    And I see Ask to change your dates card
    And I see Support and accessibility card
    And I see Juror eligibility card
    ...
    Examples:
      ...
      | 043100180		| LNAMETWOSIXZERO	| BN7 1AA	| email@outlook.com	| 431300165		|