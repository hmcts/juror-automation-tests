Feature: DBD Information Cards
  ...
  Scenario Outline: JS-1000 DBD - Where and when to attend Info
    ...
    And I see "You should allow extra time to go through security at court." on the page
    And I see "Information on this and what you can and can't take in can be found here: entering court or tribunal building (opens in a new tab)" on the page

    When I click on the "entering court or tribunal building (opens in a new tab)" link
    And I focus page to the new tab
    Then I see "www.gov.uk/entering-court-or-tribunal-building" in the URL
  ...
  Scenario Outline: JS-1001 DBD - Juror Service Info
    ...
    And I see "There is more information available here: jury service (opens in a new tab)" on the page

    When I click on the "jury service (opens in a new tab)" link
    And I focus page to the new tab
    Then I see "www.gov.uk/jury-service" in the URL

    When I focus page to the original tab

    Then I press the "Start your response" button
    And I see "Is the name we have for you correct?" on the page
  ...
  Scenario Outline: JS-1002 DBD - Support and Accessibility Info
    ...
    Then I see "steps/response-information/support" in the URL

    When I focus page to the original tab
    And I press the "Start your response" button
  ...
  Scenario Outline: JS-1003 DBD - Employment and time off work Info
    ...
    And I see "Your employer has to let you do jury service – it's the law, but they can ask you to apply to change the dates to a more convenient time (you can only do this once)." on the page
    And I see "See the information about asking to change your dates or be excused, or check delaying or being excused from jury service for more details." on the page
    ...
    When I click on the "delaying or being excused from jury service" link
    And I focus page to the new tab
    Then I see "www.gov.uk/jury-service/delaying-or-being-excused-from-jury-service" in the URL

    When I focus page to the original tab
    Then I see "Check the information in the 'claiming expenses' section or at jury service for more details." on the page

    When I click on the "jury service" link
    And I focus page to the new tab
    Then I see "www.gov.uk/jury-service" in the URL
  ...
  Scenario Outline: JS-1004 DBD - Claiming expenses Info
    ...
    And I see "The maximum rates you can claim are shown here: jury service" on the page
    ...
    And I see "You cannot claim more if your full pay is higher than these rates." on the page
    And I see "If you work part time you can only claim for days you normally work, even if you spend a full week in court." on the page
    And I see "For example, if you normally work 3 days a week, you can only claim loss of earnings for those 3 days, as you've not lost earnings on the other 2 days." on the page
  ...
  Scenario Outline: JS-1005 DBD - Ask to change your dates Info
    ...
    And I see "If you need more information, please see delaying or being excused from jury service (opens in a new tab)" on the page

    When I click on the "delaying or being excused from jury service (opens in a new tab)" link
    And I focus page to the new tab
    And I see "www.gov.uk/jury-service/delaying-or-being-excused-from-jury-service" in the URL
