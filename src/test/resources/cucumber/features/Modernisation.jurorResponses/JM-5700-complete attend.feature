Feature: As a jury officer I need to send a complete attend message
  ...
  Scenario Outline: Send complete attend message for Juror using Text including error checks
    ...
    And I click on the "Complete juror - attended" link
    And I see "Message details" on the page
    And I see the draft message template
    And I see "You are not required to attend court any further and are formally discharged from jury service. If you have any questions, please contact the jury office on <court_phone>." on the page
  ...
  Scenario Outline: Send complete attend message for Juror using Text for multiple jurors
    ...
    Examples:
      ...
      |MODTESTCOURT | 041529953    | 041529952      |041529951       |415980995   |