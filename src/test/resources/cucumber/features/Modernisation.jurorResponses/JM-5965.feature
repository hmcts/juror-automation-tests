Feature: JM-5965 - Certificate of Exemption
  ...
  @JurorTransformationMulti @NewSchemaConverted @JM-6571
  Scenario Outline:As a jury officer I want to print a certification of exemption letter for a juror in a trial
    ...
    And I see "juror-test-bureau.clouddev.online/documents/certificate-of-exemption-list/EXEMPTIONCERT2?durationType=specific&durationYears=2" in the URL
