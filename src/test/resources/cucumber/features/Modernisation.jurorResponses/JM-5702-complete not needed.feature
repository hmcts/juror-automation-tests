...
#    And I set the radio button to "Juror number"
    ...
    And I see "You are no longer required to attend court and are formally discharged from jury service. If you have any questions, please contact the jury office on 01244 317606." on the page
    And I press the "Send message" button
