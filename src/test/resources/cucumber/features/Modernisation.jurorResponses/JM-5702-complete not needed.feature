Feature: As a jury officer I need to send a complete not needed message
  ...
  Scenario Outline: Send complete not needed message for Juror using Text including error checks
    ...
    And I click on the "Complete juror - not needed" link
    And I see "Message details" on the page
    And I see the draft message template
    And I see "You are no longer required to attend court and are formally discharged from jury service. If you have any questions, please contact the jury office on <court_phone>." on the page
...
#    And I set the radio button to "Juror number"
    ...
    And I see "You are no longer required to attend court and are formally discharged from jury service. If you have any questions, please contact the jury office on 01244 356726." on the page
    And I press the "Send message" button
    ...
    Examples:
      ...
      |MODTESTCOURT | 041529950    | 415980994   |
...
#    And I set the radio button to "Pool"
    ...
    And I click on the methods dropdown and select "Text" for juror "<juror_number>"
    And I check the juror "<juror_number>" checkbox
    And I click on the methods dropdown and select "Text" for juror "<juror_number_2>"
    ...
    Examples:
      ...
      |MODTESTCOURT | 041529943    | 041529942      |041529941       |415980994   |