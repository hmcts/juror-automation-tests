Feature: JM-5967 - As a jury officer I need to be able to print a show cause letter
  ...
  @JurorTransformationWIP @NewSchemaConverted @JM-6827
  ...
  @JurorTransformationWIP @NewSchemaConverted @JM-6827
  Scenario Outline: Create and Print a show cause letter - print now
    ...
    #its not yet clear what the scenario is for the 'print now' option so will continue script once bug JM-6827 is resolved


    Examples:
      | juror_number  |juror_number_2  |pool_number | user          |
      |  041549521    | 041549522      |415991189   | MODTESTCOURT  |