Feature: As a jury officer i need to send a attendance date and time changed message
  ...
  Scenario Outline: Send next due at court message for Juror using Text including error checks
    ...
    And I click on the "Next due at court date" link
    And I see "Message details" on the page
    And I see the draft message template
    And I see "You are next required to attend for Jury Service on <attend_date> at <attend_time> at <court_name> Court. If you have any questions, please contact the jury office on <court_phone>." on the page
    ...
    And I see "You are next required to attend for Jury Service on" on the page
    And I see "at 09:00 at CHESTER Court. If you have any questions, please contact the jury office on 01244 356726." on the page
...
#    And I set the radio button to "Date deferred to"
    ...
    Examples:
      ...
      |MODTESTCOURT | 041529934    | 415980993   | ithc        |
...
#    And I set the radio button to "Pool"
    ...
    Examples:
      ...
      |MODTESTCOURT | 041529933    | 041529932      |041529931       |415980993   |