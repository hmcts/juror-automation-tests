...
Scenario Outline: Postpone a juror to another court as a Bureau officer - Bulk flow happy path
    ...
    @JurorTransformationMulti
    Scenario Outline: Postpone a juror to another court as a Bureau officer - Bulk flow Unhappy path
        Given I am on "Bureau" "test"
        ...
        Examples:
            |user		   |juror_number  | juror_number_2  |juror_number_3  |juror_number_4  | pool_number  |
            |MODTESTBUREAU |041520789     | 041520769       |041520779       |041520719       |415300901     |
    ...
    Scenario Outline: Postpone a juror to another court as a Jury officer - Bulk flow UNHAPPY PATH
        ...
        And I update juror "<juror_number>" to have a have a date of birth which is ineligible for postponement
        ...
        And I see juror "<juror_number>" in the jurors cannot be moved table
