Feature: JM-5405-5407 - Resend deferral granted letter for Bureau and Jury users
  ...
  #confirm/sign
    ...
    And I update juror "<juror_number>" to change the status of printed in order to resend deferred granted letter
    And I press the "Apps" button
    ...
    And I set "Enter juror name, number or postcode" to "<juror_number>"
    And I press the "Search" button
    And I am able to see and interact with the jurors Deferral granted letter tabs and fields
...
#update the 2nd juror number to deferred
  ...
  #search via pool  number and resend letter for first deferred juror
    ...
    And I update juror "<juror_number_1>" to change the status to Excused
  ...
  @JurorTransformationMulti @NewSchemaConverted
  Scenario Outline:As a jury officer test a Deferred juror can resend a granted letter by searching via juror number
  ...
  @JurorTransformationMulti @NewSchemaConverted
  Scenario Outline:As a jury officer test a Deferred juror can resend a granted letter by searching via pool number
