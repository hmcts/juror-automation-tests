...
#    And I set the radio button to "Juror number"
    ...
    And I see "You have been excused from attending jury service on this occasion and are no longer required to attend court. If you have any questions, please contact the jury office on 01244 356726." on the page
    And I press the "Send message" button
